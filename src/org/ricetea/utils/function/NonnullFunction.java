...
@FunctionalInterface
public interface NonnullFunction<@Nonnull T, R> {
     ...
     */
    @Nonnull
    default <@Nonnull V> NonnullFunction<V, R> compose(Function<? super V, ? extends T> before) {
     ...
     */
    @Nonnull
    default <@Nonnull V> NonnullFunction<V, R> compose(NonnullFunction<? super V, ? extends T> before) {
        Objects.requireNonNull(before);
        return (V v) -> {
