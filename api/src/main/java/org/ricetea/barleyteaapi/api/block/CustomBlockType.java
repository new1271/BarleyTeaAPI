...
import org.ricetea.barleyteaapi.api.internal.block.CustomBlockTypeImpl;
import org.ricetea.barleyteaapi.api.internal.block.EmptyCustomBlockTypeImpl;
...
public interface CustomBlockType extends EitherOperation<Material, CustomBlock>, Keyed {
    ...
    static CustomBlockType get(@Nullable NamespacedKey key) {
        if (key == null || Constants.EMPTY_NAMESPACED_KEY.equals(key))
            return empty();
        else {
